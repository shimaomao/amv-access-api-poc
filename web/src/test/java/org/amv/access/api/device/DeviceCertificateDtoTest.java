...
public class DeviceCertificateDtoTest {

    private final ObjectMapper objectMapper = new ObjectMapper()
            .configure(SerializationFeature.INDENT_OUTPUT, true);

    @Test
    public void itShouldBeSerializedAsJsonInCorrectFormat() throws IOException {
        ...
        String json = objectMapper.writeValueAsString(deviceCertificateDto);
